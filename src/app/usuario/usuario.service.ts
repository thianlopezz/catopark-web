...
export class UsuarioService {
  ...
  getAll() {
    ...
    return this.http.get('/api/usuarios/all/' + param, this.jwt()).map((response: Response) => response.json());
  }
  ...
  getPorId(idusuario) {
    ...
    return this.http.get('/api/usuarios/porid/' + param, this.jwt()).map((response: Response) => response.json());
  }
